...
- Responsividade: Adaptações de layout usando "media queries" para diferentes tamanhos de tela.

O que pratiquei neste projeto

- Estruturação semântica do código HTML.
- Organização de CSS reutilizável com variáveis ":root".
- Alinhamento de cards e imagens do portfólio usando Flexbox.
- Ajuste de navegação e tipografia para telas menores e maiores.


Projeto feito para fixação de conceitos durante o curso.
